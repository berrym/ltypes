...
void intLinkedList()
{
    ...
    ll_foreach(l, iterFuncIntListFind, true);
    printf("Done\n\n");
    ...
    printf("Second half:\n");
    ll_foreach(b, iterFuncIntListFind, true);
    printf("First half:\n");
    ll_foreach(l, iterFuncIntListFind, true);
    printf("Done...\n\n");
...
void intDLinkedList()
{
    ...
    dll_foreach(l, iterFuncIntListFind, true);
    printf("Done\n\n");
    ...
    printf("Second half:\n");
    dll_foreach(b, iterFuncIntListFind, true);
    printf("First half:\n");
    dll_foreach(l, iterFuncIntListFind, true);
    printf("Done...\n\n");
...
void stringLinkedList()
{
    ...
    getchar();
    ll_foreach(l, iterFuncStringListFind, true);
    printf("Done...\n\n");
...
void stringDLinkedList()
{
    ...
    printf("Test 3: Iterate over list and print values found...");
    getchar();
    dll_foreach(l, iterFuncStringListFind, true);
    printf("Done...\n\n");
